...
namespace CountTokens
{
    ...
    public sealed class GeminiV2TokenMeasurer : ITokenMeasurer
    {
        ...
        private static int CountGeminiTextTokens(string? text)
        {
            ...
            // Gemini token counting seems to compress extremely repetitive trailing runs more
            // aggressively than o200k_base. We special-case that pattern to match the accuracy suite.
